...
import { List, CheckCircle, Plus, Clock } from 'lucide-react';
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-6 bg-gradient-to-br from-background to-muted/20">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border-blue-500/20">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-blue-500">{stats.totalLists}
</div>
                    ...
                    <Card className="bg-gradient-to-br from-green-500/10 to-green-600/10 border-green-500/20">
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-green-500">{stats.totalTasks}
</div>
                    ...
                    <Card className="bg-gradient-to-br from-purple-500/10 to-purple-600/10 border-purple-500/20">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">Tasks you completed</p>
                        </CardContent>
                    </Card>
                </div>
